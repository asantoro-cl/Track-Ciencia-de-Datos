...
Proveedores del Estado (Oferta de Mercado): Empresas de todos los tamaños (desde personas naturales y PYMEs hasta multinacionales) inscritas en el Registro de Proveedores. Tienen asignados perfiles de gestión dentro de la plataforma para cotizar, ofertar y facturar.
Organismos de Control y Fiscalización:
ChileCompra: Como administrador de la plataforma y órgano regulador normativo que monitorea el comportamiento del mercado.
...
| :--- | :---: | :--- |
| **Compra Ágil** | Hasta 100 UTM | Proceso simplificado y rápido. Prioriza a Empresas de Menor Tamaño (EMT) y proveedores locales para fomentar la economía regional. |
| **Licitación Pública** | Regla general (sobre 30 UTM) | Proceso concursal, abierto y transparente. La entidad pública publica las Bases de Licitación (requisitos técnicos, administrativos y ponderaciones), las empresas compiten y la comisión evalúa para adjudicar a la mejor oferta. |
| **Convenio Marco** | Catálogo Electrónico (e-commerce) | ChileCompra licita grandes rubros estandarizados (tecnología, insumos médicos, combustible). Los proveedores seleccionados quedan en una tienda virtual tipo e-commerce donde los organismos compran directamente. |
| **Licitación Privada** | Excepcional (con justificación legal) | Se utiliza bajo causales estrictamente fundadas. |
| **Trato Directo** | Excepcional (fundado) | Contratación directa con un proveedor específico bajo causales legales estrictas (emergencia, proveedor único). |
| **Compra Coordinada** | Sin límite / Agregación | ChileCompra o los organismos agrupan su demanda para negociar mejores precios por volumen. |
...
Salud (30% - 35% del total): Lidera históricamente en montos (sobre US$ 6.100M anuales), caracterizado por alto volumen de ítems (fármacos, insumos médicos, instrumental) e intermediación de CENABAST.
Municipalidades (22% - 25% del total): Alrededor de US$ 4.500M anuales. Es el sector con mayor dispersión geográfica y mayor heterogeneidad en la calidad del dato de las descripciones.
Obras Públicas y Gobierno Central (15% - 25% del total): Compras de menor volumen pero con altos montos unitarios (proyectos de infraestructura, concesiones, servicios TI).
Fuerzas Armadas y de Orden: Concentrado en logística, equipamiento y mantenimiento.
3. Áreas de Interés Analítico para el Track de Ciencia de Datos
Calidad de Textos (NLP): Los ítems de las Órdenes de Compra (OC) sufren de variabilidad en descripciones (ej. "Resma carta" vs "Papel resma tamaño carta 75g"). El análisis de texto es fundamental para la estandarización.
Detección de anomalías / Outliers: Con la reforma de probidad (Ley N° 21.634), identificar variaciones atípicas de precios unitarios o fraccionamiento de compras es un caso de uso con alto impacto real.
Network Analysis (Redes): Mapear relaciones entre RUTs de compradores, proveedores e integrantes de comisiones evaluadoras para encontrar concentraciones de mercado o eventuales conflictos de interés.
